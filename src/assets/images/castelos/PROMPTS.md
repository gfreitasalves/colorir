...
SUBJECT:
A fairy tale castle with tall towers and flags
```
...
SUBJECT:
A castle on a hill with fluffy clouds
```
...
SUBJECT:
A castle with a drawbridge over a moat
```
...
SUBJECT:
A cozy cottage-style castle with a small garden
```
...
SUBJECT:
A castle silhouette with a rainbow overhead
```
...
SUBJECT:
A castle with a friendly cartoon dragon flying nearby
```
