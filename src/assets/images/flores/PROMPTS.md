...
SUBJECT:
A daisy with a ladybug on a petal
```
...
SUBJECT:
A flower pot with three different flowers
```
...
SUBJECT:
A garden scene with butterflies flying between flowers
```
