# Prompts prontos — Fadas e Criaturas Mágicas
...
SUBJECT:
A fairy with wings sitting on a mushroom
```
...
SUBJECT:
A unicorn with a long flowing mane
```
...
SUBJECT:
A fairy waving a magic wand with sparkles
```
...
SUBJECT:
A fairy flying next to a butterfly
```
