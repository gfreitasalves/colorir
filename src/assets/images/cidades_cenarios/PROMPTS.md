# Prompts prontos — Cidades e Cenários
...
SUBJECT:
A simple city skyline with a few buildings
```
...
SUBJECT:
A cute house on a street with a tree
```
...
SUBJECT:
A park scene with a bench and trees
```
...
SUBJECT:
A beach scene with a sun and gentle waves
```
