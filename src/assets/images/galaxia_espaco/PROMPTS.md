# Prompts prontos — Galáxia e Espaço
...
SUBJECT:
A rocket ship flying past stars
```
...
SUBJECT:
An astronaut waving on the moon
```
...
SUBJECT:
A friendly alien next to a UFO
```
...
SUBJECT:
Planets with rings surrounded by stars
```
...
SUBJECT:
A rocket flying between a smiling sun and moon
```
